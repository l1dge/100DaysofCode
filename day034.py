...
URL_FRONT = "http://www.amazon.com/dp/"
URL_BACK = "/?tag=pyb0f-20"


def generate_affiliation_link(url):
    lines = [line for line in url.splitlines()]
    aLinks = []
    for line in lines:
        words = line.split("/")
        aLinks.append(words[words.index("dp") + 1])
    linkID = [str(URL_FRONT + link + URL_BACK) for link in aLinks]
